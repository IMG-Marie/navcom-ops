...
// ── Constants ──────────────────────────────────────────────
const USERS = [
  { id:'marie',    name:'Marie',    role:'Operations Director',           color:'#843C0C', initials:'MA', access:'director' },
  { id:'jordan',   name:'Jordan',   role:'Operations Manager',            color:'#1F4E79', initials:'JO', access:'manager' },
  { id:'banseh',   name:'Banseh',   role:'Senior Ops Coordinator',        color:'#0070C0', initials:'BA', access:'coordinator' },
  { id:'lely',     name:'Lely',     role:'Operations Coordinator',        color:'#2E75B6', initials:'LE', access:'coordinator' },
  { id:'jose',     name:'Jose',     role:'Night Shift Coordinator',       color:'#375623', initials:'JS', access:'coordinator' },
  { id:'lea',      name:'Lea',      role:'Client Relations Manager',      color:'#C00000', initials:'LA', access:'relations' },
  { id:'haslinda', name:'Haslinda', role:'Procurement Officer',           color:'#7030A0', initials:'HA', access:'procurement' },
  { id:'veronica', name:'Veronica', role:'Procurement & Admin Asst',      color:'#7030A0', initials:'VE', access:'procurement' },
  { id:'ayu',      name:'Ayu',      role:'Accounts / Finance',            color:'#006064', initials:'AY', access:'finance' },
  { id:'aimy',     name:'Aimy',     role:'Accounts / Finance',            color:'#006064', initials:'AI', access:'finance' },
]
  ...
  return (
    <div className="login-screen">
      ...
      <div className="login-grid">
        {USERS.map(u => (
          <button key={u.id} className="login-btn" onClick={() => onLogin(u)}
